...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3 class="card-title mb-0">Data Informasi Publik</h3>
        <a href="{{ route('admin.informasi-publik.create') }}" class="btn btn-primary btn-sm">
            <i class="fas fa-plus"></i> Tambah Informasi Publik
        </a>
    </div>
    ...
    <div class="card-body">
        ...
        <form method="GET" action="{{ route('admin.informasi-publik.index') }}" class="mb-3">
            <div class="row">
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <a href="{{ route('admin.informasi-publik.index') }}" class="btn btn-secondary">Reset</a>
                </div>
            </div>
        </form>
                ...
                <tbody>
                    @forelse($items as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.informasi-publik.show', $item->id) }}" class="btn btn-info btn-sm">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.informasi-publik.edit', $item->id) }}" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.informasi-publik.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus informasi publik ini?')">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="text-center">Belum ada informasi publik.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
